...
export function EditInvoice({ invoice, address, email, firstName, lastName }) {
  ...
  const [quantity, setQuantity] = useState(invoice.invoiceItemQuantity?.toString() || "");
          ...
          <div className="flex flex-col gap-1 w-fit mb-6">
            <div className="flex items-center gap-4">
              ...
              <Input
                ...
                defaultValue={invoice.invoiceName || fields.invoiceName.initialValue}
            ...
            <div>
              ...
              <div className="flex">
                ...
                <Input
                  ...
                  defaultValue={invoice.invoiceNumber || fields.invoiceNumber.initialValue}
            ...
            <div>
              ...
              <div className="space-y-2">
                <Input
                  ...
                  defaultValue={invoice.clientName || fields.clientName.initialValue}
                ...
                <Input
                  ...
                  defaultValue={invoice.clientEmail || fields.clientEmail.initialValue}
                ...
                <Input
                  ...
                  defaultValue={invoice.clientAddress || fields.clientAddress.initialValue}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <Select
                ...
                defaultValue={invoice.dueDate?.toString() || fields.dueDate.initialValue}
              >
                <SelectTrigger>
            ...
            <div className="grid grid-cols-12 gap-4 mb-4">
              <div className="col-span-6">
                <Textarea
                  ...
                  defaultValue={invoice.invoiceItemDescription || fields.invoiceItemDescription.initialValue}
