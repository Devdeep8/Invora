...
export default function Home() {
  ...
  const testimonials = [
    {
      quote:
        "Invora has transformed our invoicing process. It's easy to use, and now I can focus more on growing my business!",
      author: 'John Doe',
    ...
    {
      quote:
        'The payment tracking feature is a game-changer. I know exactly when to follow up with clients for overdue invoices!',
      author: 'Sarah Smith',
    ...
    {
      quote:
        "We've reduced our accounting overhead by 35% since switching to Invora. The automation is incredible!",
  ...
  return (
    <div className='bg-gradient-to-b from-gray-50 to-white font-sans overflow-hidden'>
          ...
          >
            <div className='max-w-screen-xl mx-auto px-6 flex justify-between items-center'>
              ...
              <div className='flex items-center gap-6'>
                <Button variant='ghost' className='text-blue-800'>
                  Features
                </Button>
                <Button variant='ghost' className='text-blue-800'>
                  Pricing
      ...
      <section
        ref={heroRef}
        className='relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-32 overflow-hidden'
      >
        ...
        >
          ...
          >
            ...
            >
              Automate your invoicing, track payments, and focus on what
              matters. Invora simplifies invoice management for your business.
            </motion.p>
          </motion.div>
      ...
      <section className='py-16 bg-white'>
        <div className='max-w-screen-xl mx-auto px-6'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
            ...
            >
              <h3 className='text-4xl font-bold text-blue-800 mb-2'>
                {counters.invoices.toLocaleString()}+
              </h3>
      ...
      <section className='py-20 bg-gradient-to-b from-white to-blue-50'>
        <div className='max-w-screen-xl mx-auto px-6'>
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Badge className='mb-4 bg-blue-100 text-blue-800 hover:bg-blue-200 px-3 py-1'>
              Features
            </Badge>
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Our platform is designed to make invoice management effortless and
              efficient.
            </p>
          </motion.div>
              ...
              <Card className='h-full overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300 group-hover:translate-y-[-5px]'>
                <CardContent className='p-6'>
                  ...
                  <p className='text-gray-600'>
                    Generate and send invoices automatically with customized
                    templates and due dates. Save time and reduce errors.
                  </p>
                  <motion.div
            ...
            >
              <Card className='h-full overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300 group-hover:translate-y-[-5px]'>
                <CardContent className='p-6'>
                  ...
                  <p className='text-gray-600'>
                    Track paid, pending, and overdue invoices in real-time for
                    better cash flow management and client follow-ups.
                  </p>
                  <motion.div
            ...
            >
              <Card className='h-full overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300 group-hover:translate-y-[-5px]'>
                <CardContent className='p-6'>
                  ...
                  <p className='text-gray-600'>
                    Get detailed reports on your earnings, outstanding invoices,
                    and financial health with visual dashboards.
                  </p>
                  <motion.div
        ...
        <div className='max-w-screen-xl mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              ...
              customers have to say about Invora.
            </p>
          </motion.div>
        ...
        <div className='max-w-screen-lg mx-auto text-center px-6 relative z-10'>
          ...
          >
            ...
            <p className='text-xl mb-8 max-w-2xl mx-auto'>
              Join thousands of businesses already using Invora. Get started
      ...
      <footer className='bg-gray-900 text-white py-12'>
        <div className='max-w-screen-xl mx-auto px-6'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8 mb-8'>
            <div>
              ...
              <p className='text-gray-400'>
                Simplifying invoice management for service-based businesses
                worldwide.
              </p>
            </div>
            <div>
          ...
          <div className='border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center'>
            <p>
              &copy; {new Date().getFullYear()} Invora. All rights reserved.
            </p>
